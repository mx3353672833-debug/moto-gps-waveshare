...
1. [DIY 制作教程](WAVESHARE_DIY_GUIDE.md)：买哪个设备、烧录固件、安装 iPhone App 和首次配对。
2. [功能与使用说明书](USER_MANUAL.md)：搜索、候选路线、四个页面、音乐、连接与日常操作。
3. [路线网关配置](GATEWAY_SETUP.md)：真实搜索与导航所需的 Key、服务、HTTPS 和验证步骤。
