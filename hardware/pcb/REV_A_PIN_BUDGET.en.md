> **Language:** English · [中文](REV_A_PIN_BUDGET.md)

> English edition of the Chinese document. The Chinese file is authoritative if the two differ.

# Rev A GPIO / interface budget

Status: A0 has been superseded by `hardware/rev_a/ARCHITECTURE_FREEZE.md`. The table below is retained in step for reference by older documents; the new design follows the Rev A freeze.
